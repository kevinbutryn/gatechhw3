...
print('PCA....')
time_pca = []
n_components_pca = range(1,X.shape[1])
cv_score_pca = []
...
plt.title("NN accuracy with dimensionally reduced dataset using PCA - " + dataset)
plt.show()
...
print('ICA...')
n_components_ica = range(1,X.shape[1])
cv_score_ica = []
time_ica = []
...
plt.xlabel("Number of components")
plt.ylabel("Three fold Cross Validation score")
plt.title("NN accuracy with dimensionally reduced dataset using ICA - "+dataset)
plt.show()
...
print('RP...')
n_components_rp = range(1,X.shape[1])
cv_score_rp = []
...
plt.xlabel("Number of components")
plt.ylabel("Three fold Cross Validation score")
plt.title("NN accuracy with dimensionally reduced dataset using RP - "+dataset)
plt.show()
...
print('FA...')
n_components_fa = range(1,X.shape[1])
cv_score_fa = []
...
plt.xlabel("Number of components")
plt.ylabel("Three fold Cross Validation score")
plt.title("NN accuracy with dimensionally reduced dataset using FA - " +dataset)
plt.show()
...
plt.title("NN computation time after dimensionality reduction - "+dataset )
plt.show()
